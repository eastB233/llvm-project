...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     8.0    0.5    0.0       mul	x0, x0, x0
# CHECK-NEXT: 1.     2     12.0   0.0    0.0       madd	x0, x1, x2, x0
# CHECK-NEXT: 2.     2     15.0   0.0    0.0       madd	x0, x1, x2, x0
# CHECK-NEXT: 3.     2     19.0   0.0    0.0       madd	x0, x0, x0, x0
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     6.5    0.5    0.0       mul	x0, x0, x0
# CHECK-NEXT: 1.     2     10.5   0.0    0.0       smaddl	x0, w1, w2, x0
# CHECK-NEXT: 2.     2     12.5   0.0    0.0       smaddl	x0, w1, w2, x0
# CHECK-NEXT: 3.     2     15.5   0.0    0.0       smaddl	x0, w0, w0, x0
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     5.0    0.5    0.0       mul	v0.4s, v0.4s, v0.4s
# CHECK-NEXT: 1.     2     6.0    0.0    0.0       sdot	v0.4s, v1.16b, v2.16b
# CHECK-NEXT: 2.     2     7.0    0.0    0.0       sdot	v0.4s, v1.16b, v2.16b
# CHECK-NEXT: 3.     2     10.0   0.0    0.0       sdot	v0.4s, v0.16b, v1.16b
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     5.0    0.5    0.0       mul	v0.4s, v0.4s, v0.4s
# CHECK-NEXT: 1.     2     6.0    0.0    0.0       smmla	v0.4s, v1.16b, v2.16b
# CHECK-NEXT: 2.     2     7.0    0.0    0.0       smmla	v0.4s, v1.16b, v2.16b
# CHECK-NEXT: 3.     2     10.0   0.0    0.0       smmla	v0.4s, v0.16b, v1.16b
# CHECK-NEXT:        8     7.0    0.1    0.0       <total>
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     5.0    0.5    0.0       mul	v0.4s, v0.4s, v0.4s
# CHECK-NEXT: 1.     2     6.0    0.0    0.0       mla	v0.4s, v1.4s, v2.4s
# CHECK-NEXT: 2.     2     7.0    0.0    0.0       mla	v0.4s, v1.4s, v2.4s
# CHECK-NEXT: 3.     2     10.0   0.0    0.0       mla	v0.4s, v0.4s, v1.4s
# CHECK-NEXT:        8     7.0    0.1    0.0       <total>
...
# CHECK-NEXT: 1.     2     8.0    0.0    0.0       sqrdmlah	v0.4s, v1.4s, v2.4s
# CHECK-NEXT: 2.     2     10.0   0.0    0.0       sqrdmlah	v0.4s, v1.4s, v2.4s
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       sqrdmlah	v0.4s, v0.4s, v1.4s
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     5.0    0.5    0.0       mul	v0.4s, v0.4s, v0.4s
# CHECK-NEXT: 1.     2     6.0    0.0    0.0       smlal2	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: 2.     2     7.0    0.0    0.0       smlal2	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: 3.     2     10.0   0.0    0.0       smlal2	v0.4s, v0.8h, v1.8h
# CHECK-NEXT:        8     7.0    0.1    0.0       <total>
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     5.0    0.5    0.0       mul	v0.4s, v0.4s, v0.4s
# CHECK-NEXT: 1.     2     6.0    0.0    0.0       sadalp	v0.2d, v1.4s
# CHECK-NEXT: 2.     2     7.0    0.0    0.0       sadalp	v0.2d, v1.4s
# CHECK-NEXT: 3.     2     10.0   0.0    0.0       sadalp	v0.2d, v0.4s
# CHECK-NEXT:        8     7.0    0.1    0.0       <total>
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     6.0    0.5    0.0       mul	v0.4s, v0.4s, v0.4s
# CHECK-NEXT: 1.     2     8.0    0.0    0.0       ssra	v0.2d, v1.2d, #1
# CHECK-NEXT: 2.     2     10.0   0.0    0.0       ssra	v0.2d, v1.2d, #1
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       ssra	v0.2d, v0.2d, #1
# CHECK-NEXT:        8     9.3    0.1    0.0       <total>
...
# CHECK:      [0,0]     DeeeER    .    .    .    .    .    .    .   .   fmul	v0.2d, v0.2d, v0.2d
# CHECK-NEXT: [0,1]     D===eeeeeeER   .    .    .    .    .    .   .   bfdot	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: [0,2]     D=========eeeeeeER  .    .    .    .    .   .   bfdot	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: [0,3]     D===============eeeeeeER .    .    .    .   .   bfdot	v0.4s, v0.8h, v1.8h
# CHECK-NEXT: [1,0]     D=====================eeeER   .    .    .   .   fmul	v0.2d, v0.2d, v0.2d
# CHECK-NEXT: [1,1]     .D=======================eeeeeeER  .    .   .   bfdot	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: [1,2]     .D=============================eeeeeeER .   .   bfdot	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: [1,3]     .D===================================eeeeeeER   bfdot	v0.4s, v0.8h, v1.8h
...
# CHECK-NEXT: 1.     2     14.0   0.0    0.0       bfdot	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: 2.     2     20.0   0.0    0.0       bfdot	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: 3.     2     26.0   0.0    0.0       bfdot	v0.4s, v0.8h, v1.8h
# CHECK-NEXT:        8     17.9   0.1    0.0       <total>
...
# CHECK:      [0,0]     DeeeER    .    .    .    .    .    .    .    .    .    ..   fmul	v0.2d, v0.2d, v0.2d
# CHECK-NEXT: [0,1]     D===eeeeeeeeER .    .    .    .    .    .    .    .    ..   bfmmla	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: [0,2]     .D==========eeeeeeeeER   .    .    .    .    .    .    ..   bfmmla	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: [0,3]     .D==================eeeeeeeeER.    .    .    .    .    ..   bfmmla	v0.4s, v0.8h, v1.8h
# CHECK-NEXT: [1,0]     . D=========================eeeER  .    .    .    .    ..   fmul	v0.2d, v0.2d, v0.2d
# CHECK-NEXT: [1,1]     . D============================eeeeeeeeER    .    .    ..   bfmmla	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: [1,2]     .  D===================================eeeeeeeeER .    ..   bfmmla	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: [1,3]     .  D===========================================eeeeeeeeER   bfmmla	v0.4s, v0.8h, v1.8h
...
# CHECK-NEXT: 1.     2     16.5   0.0    0.0       bfmmla	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: 2.     2     23.5   0.0    0.0       bfmmla	v0.4s, v1.8h, v2.8h
# CHECK-NEXT: 3.     2     31.5   0.0    0.0       bfmmla	v0.4s, v0.8h, v1.8h
# CHECK-NEXT:        8     21.3   0.1    0.0       <total>
...
# CHECK-NEXT: 1.     2     8.0    0.0    0.0       crc32b	w0, w0, w1
# CHECK-NEXT: 2.     2     10.0   0.0    0.0       crc32b	w0, w0, w1
# CHECK-NEXT: 3.     2     12.0   0.0    0.0       crc32b	w0, w0, w0
# CHECK-NEXT:        8     8.8    0.1    0.0       <total>
...
# CHECK-NEXT: 2.     2     9.5    0.0    0.0       saba	z0.d, z1.d, z2.d
# CHECK-NEXT: 3.     2     11.0   0.0    0.0       saba	z0.d, z0.d, z1.d
# CHECK-NEXT:        8     8.6    0.1    0.0       <total>
...
# CHECK-NEXT: 1.     2     11.0   0.0    0.0       sadalp	z0.d, p0/m, z1.s
# CHECK-NEXT: 2.     2     13.5   0.0    0.0       sadalp	z0.d, p0/m, z1.s
# CHECK-NEXT: 3.     2     16.0   0.0    0.0       sadalp	z0.d, p0/m, z0.s
...
# CHECK-NEXT: 2.     2     12.0   0.0    0.0       ssra	z0.d, z1.d, #1
# CHECK-NEXT: 3.     2     14.5   0.0    0.0       ssra	z0.d, z0.d, #1
# CHECK-NEXT:        8     10.9   0.1    0.0       <total>
...
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       cdot	z0.s, z0.b, z1.b, #90
# CHECK-NEXT:        8     9.9    0.1    0.0       <total>
...
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       cdot	z0.d, z0.h, z1.h, #90
# CHECK-NEXT:        8     9.9    0.1    0.0       <total>
...
# CHECK-NEXT: 2.     2     10.5   0.0    0.0       cmla	z0.b, z1.b, z2.b, #90
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       cmla	z0.b, z0.b, z1.b, #90
# CHECK-NEXT:        8     9.9    0.1    0.0       <total>
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     6.0    0.5    0.0       mul	z0.d, z0.d, z0.d
# CHECK-NEXT: 1.     2     8.0    0.0    0.0       cmla	z0.d, z1.d, z2.d, #90
# CHECK-NEXT: 2.     2     9.0    0.0    0.0       cmla	z0.d, z1.d, z2.d, #90
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       cmla	z0.d, z0.d, z1.d, #90
...
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       sdot	z0.s, z0.b, z1.b
# CHECK-NEXT:        8     9.9    0.1    0.0       <total>
...
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       sdot	z0.s, z0.b, z1.b[1]
# CHECK-NEXT:        8     9.9    0.1    0.0       <total>
...
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       sdot	z0.d, z0.h, z1.h
# CHECK-NEXT:        8     9.9    0.1    0.0       <total>
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     4.5    0.5    0.0       mul	z0.s, z0.s, z0.s
# CHECK-NEXT: 1.     2     5.5    0.0    0.0       smmla	z0.s, z1.b, z2.b
# CHECK-NEXT: 2.     2     6.5    0.0    0.0       smmla	z0.s, z1.b, z2.b
# CHECK-NEXT: 3.     2     9.5    0.0    0.0       smmla	z0.s, z0.b, z1.b
# CHECK-NEXT:        8     6.5    0.1    0.0       <total>
...
# CHECK-NEXT: 2.     2     10.5   0.0    0.0       mla	z0.b, p0/m, z1.b, z2.b
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       mla	z0.b, p0/m, z0.b, z1.b
# CHECK-NEXT:        8     9.9    0.1    0.0       <total>
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     6.0    0.5    0.0       mul	z0.d, z0.d, z0.d
# CHECK-NEXT: 1.     2     8.0    0.0    0.0       mla	z0.d, p0/m, z1.d, z2.d
# CHECK-NEXT: 2.     2     9.0    0.0    0.0       mla	z0.d, p0/m, z1.d, z2.d
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       mla	z0.d, p0/m, z0.d, z1.d
# CHECK-NEXT:        8     9.0    0.1    0.0       <total>
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     6.0    0.5    0.0       mul	z0.d, z0.d, z0.d
# CHECK-NEXT: 1.     2     8.0    0.0    0.0       smlalb	z0.d, z1.s, z2.s
# CHECK-NEXT: 2.     2     9.0    0.0    0.0       smlalb	z0.d, z1.s, z2.s
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       smlalb	z0.d, z0.s, z1.s
# CHECK-NEXT:        8     9.0    0.1    0.0       <total>
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     7.0    0.5    0.0       mul	z0.d, z0.d, z0.d
# CHECK-NEXT: 1.     2     10.0   0.0    0.0       sqdmlalb	z0.d, z1.s, z2.s
# CHECK-NEXT: 2.     2     12.0   0.0    0.0       sqdmlalb	z0.d, z1.s, z2.s
# CHECK-NEXT: 3.     2     16.0   0.0    0.0       sqdmlalb	z0.d, z0.s, z1.s
# CHECK-NEXT:        8     11.3   0.1    0.0       <total>
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     6.0    0.5    0.0       mul	z0.d, z0.d, z0.d
# CHECK-NEXT: 1.     2     9.0    0.0    0.0       sqrdmlah	z0.b, z1.b, z2.b
# CHECK-NEXT: 2.     2     10.5   0.0    0.0       sqrdmlah	z0.b, z1.b, z2.b
# CHECK-NEXT: 3.     2     13.0   0.0    0.0       sqrdmlah	z0.b, z0.b, z1.b
# CHECK-NEXT:        8     9.6    0.1    0.0       <total>
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     7.0    0.5    0.0       mul	z0.d, z0.d, z0.d
# CHECK-NEXT: 1.     2     10.0   0.0    0.0       sqrdmlah	z0.d, z1.d, z2.d
# CHECK-NEXT: 2.     2     12.0   0.0    0.0       sqrdmlah	z0.d, z1.d, z2.d
# CHECK-NEXT: 3.     2     16.0   0.0    0.0       sqrdmlah	z0.d, z0.d, z1.d
# CHECK-NEXT:        8     11.3   0.1    0.0       <total>
...
# CHECK-NEXT: 1.     2     11.0   0.0    0.0       fmlalb	z0.s, z1.h, z2.h
# CHECK-NEXT: 2.     2     15.0   0.0    0.0       fmlalb	z0.s, z1.h, z2.h
# CHECK-NEXT: 3.     2     19.0   0.0    0.0       fmlalb	z0.s, z0.h, z1.h
...
# CHECK:      [0,0]     DeeeER    .    .    .    .    .    .    .   .   fmul	z0.d, z0.d, z0.d
# CHECK-NEXT: [0,1]     D===eeeeeeER   .    .    .    .    .    .   .   bfdot	z0.s, z1.h, z2.h
# CHECK-NEXT: [0,2]     .D========eeeeeeER  .    .    .    .    .   .   bfdot	z0.s, z1.h, z2.h
# CHECK-NEXT: [0,3]     .D==============eeeeeeER .    .    .    .   .   bfdot	z0.s, z0.h, z1.h
# CHECK-NEXT: [1,0]     . D===================eeeER   .    .    .   .   fmul	z0.d, z0.d, z0.d
# CHECK-NEXT: [1,1]     . D======================eeeeeeER  .    .   .   bfdot	z0.s, z1.h, z2.h
# CHECK-NEXT: [1,2]     .  D===========================eeeeeeER .   .   bfdot	z0.s, z1.h, z2.h
# CHECK-NEXT: [1,3]     .  D=================================eeeeeeER   bfdot	z0.s, z0.h, z1.h
...
# CHECK-NEXT: 1.     2     13.5   0.0    0.0       bfdot	z0.s, z1.h, z2.h
# CHECK-NEXT: 2.     2     18.5   0.0    0.0       bfdot	z0.s, z1.h, z2.h
# CHECK-NEXT: 3.     2     24.5   0.0    0.0       bfdot	z0.s, z0.h, z1.h
# CHECK-NEXT:        8     16.8   0.1    0.0       <total>
...
# CHECK:      [0,0]     DeeeER    .    .    .    .    .    .    .    .    .    ..   fmul	z0.d, z0.d, z0.d
# CHECK-NEXT: [0,1]     .D==eeeeeeeeER .    .    .    .    .    .    .    .    ..   bfmmla	z0.s, z1.h, z2.h
# CHECK-NEXT: [0,2]     . D=========eeeeeeeeER   .    .    .    .    .    .    ..   bfmmla	z0.s, z1.h, z2.h
# CHECK-NEXT: [0,3]     .  D================eeeeeeeeER.    .    .    .    .    ..   bfmmla	z0.s, z0.h, z1.h
# CHECK-NEXT: [1,0]     .   D=======================eeeER  .    .    .    .    ..   fmul	z0.d, z0.d, z0.d
# CHECK-NEXT: [1,1]     .    D=========================eeeeeeeeER    .    .    ..   bfmmla	z0.s, z1.h, z2.h
# CHECK-NEXT: [1,2]     .    .D================================eeeeeeeeER .    ..   bfmmla	z0.s, z1.h, z2.h
# CHECK-NEXT: [1,3]     .    . D=======================================eeeeeeeeER   bfmmla	z0.s, z0.h, z1.h
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     12.5   0.5    0.0       fmul	z0.d, z0.d, z0.d
# CHECK-NEXT: 1.     2     14.5   0.0    0.0       bfmmla	z0.s, z1.h, z2.h
# CHECK-NEXT: 2.     2     21.5   0.0    0.0       bfmmla	z0.s, z1.h, z2.h
# CHECK-NEXT: 3.     2     28.5   0.0    0.0       bfmmla	z0.s, z0.h, z1.h
# CHECK-NEXT:        8     19.3   0.1    0.0       <total>
