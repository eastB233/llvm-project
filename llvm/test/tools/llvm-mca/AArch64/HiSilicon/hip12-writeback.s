...
# RUN: llvm-mca -mtriple=aarch64 -mcpu=hip12 --instruction-info=0 --resource-pressure=0 --timeline --timeline-max-iterations=1 < %s | FileCheck %s
...
# CHECK-NEXT: [0,3]     D==eE----R.  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eeeeeeeER .   ld1	{ v1.1d, v2.1d, v3.1d }, [x27], #24
# CHECK-NEXT: [0,5]     .D==eE-----R .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .D==eeeeeeeER.   ld1	{ v1.2d, v2.2d, v3.2d }, [x27], #48
# CHECK-NEXT: [0,7]     .D===eE-----R.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     . D==eeeeeeeER   ld1	{ v1.2s, v2.2s, v3.2s }, [x27], #24
# CHECK-NEXT: [0,9]     . D===eE-----R   add	x0, x27, #1
...
# CHECK-NEXT:        10    2.7    0.1    2.3       <total>
...
# CHECK:      [0,0]     DeeeeeeeER.  .   ld1	{ v1.4h, v2.4h, v3.4h }, [x27], #24
# CHECK-NEXT: [0,1]     D=eE-----R.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     D=eeeeeeeER  .   ld1	{ v1.4s, v2.4s, v3.4s }, [x27], #48
# CHECK-NEXT: [0,3]     D==eE-----R  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eeeeeeeER .   ld1	{ v1.8b, v2.8b, v3.8b }, [x27], #24
# CHECK-NEXT: [0,5]     .D==eE-----R .   add	x0, x27, #1
...
# CHECK:      [0,0]     DeeeeeeeER.  .   ld1	{ v1.1d, v2.1d, v3.1d }, [x27], x28
# CHECK-NEXT: [0,1]     D=eE-----R.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     D=eeeeeeeER  .   ld1	{ v1.2d, v2.2d, v3.2d }, [x27], x28
# CHECK-NEXT: [0,3]     D==eE-----R  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eeeeeeeER .   ld1	{ v1.2s, v2.2s, v3.2s }, [x27], x28
# CHECK-NEXT: [0,5]     .D==eE-----R .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .D==eeeeeeeER.   ld1	{ v1.4h, v2.4h, v3.4h }, [x27], x28
# CHECK-NEXT: [0,7]     .D===eE-----R.   add	x0, x27, #1
...
# CHECK:      [0,0]     DeeeeeeeER.  .   ld1	{ v1.8b, v2.8b, v3.8b }, [x27], x28
# CHECK-NEXT: [0,1]     D=eE-----R.  .   add	x0, x27, #1
...
# CHECK-NEXT:        10    3.9    0.1    2.6       <total>
...
# CHECK-NEXT:        10    2.5    0.1    3.0       <total>
...
# CHECK-NEXT:        10    1.3    0.2    3.4       <total>

# CHECK:      [28] Code Region - G29

# CHECK:      Iterations:        100
# CHECK-NEXT: Instructions:      1000
# CHECK-NEXT: Total Cycles:      712
# CHECK-NEXT: Total uOps:        4700

# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    6.60
# CHECK-NEXT: IPC:               1.40
# CHECK-NEXT: Block RThroughput: 5.9
...
# CHECK-NEXT: 7.     1     2.0    0.0    6.0       add	x0, x27, #1
# CHECK-NEXT: 8.     1     2.0    1.0    0.0       ld3	{ v1.4s, v2.4s, v3.4s }, [x27], x28
# CHECK-NEXT: 9.     1     2.0    0.0    8.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.4    0.3    3.4       <total>
...
# CHECK-NEXT:        10    5.9    0.2    3.4       <total>
...
# CHECK:      Iterations:        100
# CHECK-NEXT: Instructions:      1000
# CHECK-NEXT: Total Cycles:      912
# CHECK-NEXT: Total uOps:        5200

# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    5.70
# CHECK-NEXT: IPC:               1.10
...
# CHECK-NEXT: [0,8]     .    . DeeeeeeeeeeeER   ld4	{ v1.4s, v2.4s, v3.4s, v4.4s }, [x27], #64
# CHECK-NEXT: [0,9]     .    .  DeE---------R   add	x0, x27, #1
...
# CHECK-NEXT:        10    1.1    0.4    3.4       <total>
...
# CHECK-NEXT: 3.     1     1.0    0.0    9.0       add	x0, x27, #1
# CHECK-NEXT: 4.     1     1.0    1.0    0.0       ld4	{ v1.16b, v2.16b, v3.16b, v4.16b }, [x27], #64
# CHECK-NEXT: 5.     1     1.0    0.0    9.0       add	x0, x27, #1
...
# CHECK-NEXT: 9.     1     1.0    0.0    6.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.0    0.5    3.7       <total>

# CHECK:      [37] Code Region - G38

# CHECK:      Iterations:        100
# CHECK-NEXT: Instructions:      1000
# CHECK-NEXT: Total Cycles:      1012
# CHECK-NEXT: Total uOps:        6600

# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    6.52
# CHECK-NEXT: IPC:               0.99
...
# CHECK-NEXT: [0,3]     .  DeE---------R    ..   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .   DeeeeeeeeE-R    ..   ld4	{ v1.8b, v2.8b, v3.8b, v4.8b }, [x27], x28
# CHECK-NEXT: [0,5]     .    DeE-------R    ..   add	x0, x27, #1
...
# CHECK-NEXT: IPC:               1.41
# CHECK-NEXT: Block RThroughput: 4.9
...
# CHECK-NEXT:        10    1.2    0.3    2.8       <total>
...
# CHECK-NEXT: [0,5]     .D==eE--R   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .D==eE--R   st1	{ v1.1d }, [x27], #8
# CHECK-NEXT: [0,7]     .D===eE-R   add	x0, x27, #1
# CHECK-NEXT: [0,8]     . D==eE-R   st1	{ v1.2d }, [x27], #16
...
# CHECK-NEXT: 5.     1     3.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT: 6.     1     3.0    0.0    2.0       st1	{ v1.1d }, [x27], #8
# CHECK-NEXT: 7.     1     4.0    0.0    1.0       add	x0, x27, #1
# CHECK-NEXT: 8.     1     3.0    0.0    1.0       st1	{ v1.2d }, [x27], #16
# CHECK-NEXT: 9.     1     4.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT:        10    2.8    0.1    1.0       <total>
...
# CHECK-NEXT: [0,4]     . DeER  .   st1	{ v1.4s }, [x27], #16
# CHECK-NEXT: [0,5]     . D=eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  DeER .   st1	{ v1.8b }, [x27], #8
# CHECK-NEXT: [0,7]     .  D=eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .   DeER.   st1	{ v1.8h }, [x27], #16
# CHECK-NEXT: [0,9]     .   D=eER   add	x0, x27, #1
...
# CHECK:      [0,0]     DeER .  .   st1	{ v1.16b }, [x27], #16
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeER.  .   st1	{ v1.1d }, [x27], x28
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeER  .   st1	{ v1.2d }, [x27], x28
# CHECK-NEXT: [0,5]     . D=eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  DeER .   st1	{ v1.2s }, [x27], x28
# CHECK-NEXT: [0,7]     .  D=eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .   DeER.   st1	{ v1.4h }, [x27], x28
# CHECK-NEXT: [0,9]     .   D=eER   add	x0, x27, #1
...
# CHECK:      [0,0]     DeER .  .   st1	{ v1.4s }, [x27], x28
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeER.  .   st1	{ v1.8b }, [x27], x28
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeER  .   st1	{ v1.8h }, [x27], x28
# CHECK-NEXT: [0,5]     . D=eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     . D=eER .   st1	{ v1.16b }, [x27], x28
# CHECK-NEXT: [0,7]     . D==eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .  D=eER.   st1	{ v1.1d, v2.1d }, [x27], #16
# CHECK-NEXT: [0,9]     .  D==eER   add	x0, x27, #1
...
# CHECK-NEXT: 5.     1     2.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT: 6.     1     2.0    0.0    0.0       st1	{ v1.16b }, [x27], x28
# CHECK-NEXT: 7.     1     3.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT: 8.     1     2.0    0.0    0.0       st1	{ v1.1d, v2.1d }, [x27], #16
# CHECK-NEXT: 9.     1     3.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.9    0.1    0.0       <total>
...
# CHECK:      [0,0]     DeER .  .   st1	{ v1.2d, v2.2d }, [x27], #32
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeER.  .   st1	{ v1.2s, v2.2s }, [x27], #16
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeER  .   st1	{ v1.4h, v2.4h }, [x27], #16
# CHECK-NEXT: [0,5]     . D=eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  DeER .   st1	{ v1.4s, v2.4s }, [x27], #32
# CHECK-NEXT: [0,7]     .  D=eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .   DeER.   st1	{ v1.8b, v2.8b }, [x27], #16
# CHECK-NEXT: [0,9]     .   D=eER   add	x0, x27, #1
...
# CHECK:      [0,0]     DeER .  .   st1	{ v1.8h, v2.8h }, [x27], #32
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     D=eER.  .   st1	{ v1.16b, v2.16b }, [x27], #32
# CHECK-NEXT: [0,3]     D==eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eER  .   st1	{ v1.1d, v2.1d }, [x27], x28
# CHECK-NEXT: [0,5]     .D==eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     . D=eER .   st1	{ v1.2d, v2.2d }, [x27], x28
# CHECK-NEXT: [0,7]     . D==eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .  D=eER.   st1	{ v1.2s, v2.2s }, [x27], x28
# CHECK-NEXT: [0,9]     .  D==eER   add	x0, x27, #1
...
# CHECK-NEXT: 7.     1     3.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT: 8.     1     2.0    0.0    0.0       st1	{ v1.2s, v2.2s }, [x27], x28
# CHECK-NEXT: 9.     1     3.0    0.0    0.0       add	x0, x27, #1
...
# CHECK:      [0,0]     DeER .  .   st1	{ v1.4h, v2.4h }, [x27], x28
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeER.  .   st1	{ v1.4s, v2.4s }, [x27], x28
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeER  .   st1	{ v1.8b, v2.8b }, [x27], x28
# CHECK-NEXT: [0,5]     . D=eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  DeER .   st1	{ v1.8h, v2.8h }, [x27], x28
# CHECK-NEXT: [0,7]     .  D=eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .  D=eER.   st1	{ v1.16b, v2.16b }, [x27], x28
# CHECK-NEXT: [0,9]     .  D==eER   add	x0, x27, #1
...
# CHECK-NEXT: 7.     1     2.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT: 8.     1     2.0    0.0    0.0       st1	{ v1.16b, v2.16b }, [x27], x28
# CHECK-NEXT: 9.     1     3.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.7    0.1    0.0       <total>
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    6.95
# CHECK-NEXT: IPC:               1.66
...
# CHECK:      [0,0]     DeER .   .   st1	{ v1.1d, v2.1d, v3.1d }, [x27], #24
# CHECK-NEXT: [0,1]     .DeER.   .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeER.   .   st1	{ v1.2d, v2.2d, v3.2d }, [x27], #48
# CHECK-NEXT: [0,3]     .D=eER   .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeER   .   st1	{ v1.2s, v2.2s, v3.2s }, [x27], #24
# CHECK-NEXT: [0,5]     .  DeER  .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .   DeER .   st1	{ v1.4h, v2.4h, v3.4h }, [x27], #24
# CHECK-NEXT: [0,7]     .    DeER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .    DeER.   st1	{ v1.4s, v2.4s, v3.4s }, [x27], #48
# CHECK-NEXT: [0,9]     .    D=eER   add	x0, x27, #1
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    7.54
# CHECK-NEXT: IPC:               1.98
...
# CHECK:      [0,0]     DeER .  .   st1	{ v1.8b, v2.8b, v3.8b }, [x27], #24
# CHECK-NEXT: [0,1]     .DeER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeER.  .   st1	{ v1.8h, v2.8h, v3.8h }, [x27], #48
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeER  .   st1	{ v1.16b, v2.16b, v3.16b }, [x27], #48
# CHECK-NEXT: [0,5]     . D=eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  DeER .   st1	{ v1.1d, v2.1d, v3.1d }, [x27], x28
# CHECK-NEXT: [0,7]     .   DeER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .   DeER.   st1	{ v1.2d, v2.2d, v3.2d }, [x27], x28
# CHECK-NEXT: [0,9]     .   D=eER   add	x0, x27, #1
...
# CHECK:      [0,0]     DeER .   .   st1	{ v1.2s, v2.2s, v3.2s }, [x27], x28
# CHECK-NEXT: [0,1]     .DeER.   .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     . DeER   .   st1	{ v1.4h, v2.4h, v3.4h }, [x27], x28
# CHECK-NEXT: [0,3]     .  DeER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .  DeER  .   st1	{ v1.4s, v2.4s, v3.4s }, [x27], x28
# CHECK-NEXT: [0,5]     .  D=eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .   DeER .   st1	{ v1.8b, v2.8b, v3.8b }, [x27], x28
# CHECK-NEXT: [0,7]     .    DeER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .    DeER.   st1	{ v1.8h, v2.8h, v3.8h }, [x27], x28
# CHECK-NEXT: [0,9]     .    D=eER   add	x0, x27, #1
...
# CHECK:      [0,0]     DeER .    .   st1	{ v1.16b, v2.16b, v3.16b }, [x27], x28
# CHECK-NEXT: [0,1]     D=eER.    .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeeeeER  .   st1	{ v1.1d, v2.1d, v3.1d, v4.1d }, [x27], #32
# CHECK-NEXT: [0,3]     .D=eE--R  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeE--R  .   st1	{ v1.2d, v2.2d, v3.2d, v4.2d }, [x27], #64
# CHECK-NEXT: [0,5]     . D=eE-R  .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  DeeeeER.   st1	{ v1.2s, v2.2s, v3.2s, v4.2s }, [x27], #32
# CHECK-NEXT: [0,7]     .  D=eE--R.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .   DeeeeER   st1	{ v1.4h, v2.4h, v3.4h, v4.4h }, [x27], #32
# CHECK-NEXT: [0,9]     .   D=eE--R   add	x0, x27, #1
...
# CHECK-NEXT: 4.     1     1.0    0.0    2.0       st1	{ v1.2d, v2.2d, v3.2d, v4.2d }, [x27], #64
...
# CHECK-NEXT:        10    1.5    0.1    0.9       <total>
...
# CHECK:      [0,0]     DeER .    .   st1	{ v1.4s, v2.4s, v3.4s, v4.4s }, [x27], #64
# CHECK-NEXT: [0,1]     D=eER.    .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeeeeER  .   st1	{ v1.8b, v2.8b, v3.8b, v4.8b }, [x27], #32
# CHECK-NEXT: [0,3]     .D=eE--R  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeE--R  .   st1	{ v1.8h, v2.8h, v3.8h, v4.8h }, [x27], #64
# CHECK-NEXT: [0,5]     . D=eE-R  .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  DeE-R  .   st1	{ v1.16b, v2.16b, v3.16b, v4.16b }, [x27], #64
# CHECK-NEXT: [0,7]     .  D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .   DeeeeER   st1	{ v1.1d, v2.1d, v3.1d, v4.1d }, [x27], x28
# CHECK-NEXT: [0,9]     .   D=eE--R   add	x0, x27, #1
...
# CHECK-NEXT: 3.     1     2.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT: 4.     1     1.0    0.0    2.0       st1	{ v1.8h, v2.8h, v3.8h, v4.8h }, [x27], #64
# CHECK-NEXT: 5.     1     2.0    0.0    1.0       add	x0, x27, #1
# CHECK-NEXT: 6.     1     1.0    0.0    1.0       st1	{ v1.16b, v2.16b, v3.16b, v4.16b }, [x27], #64
# CHECK-NEXT: 7.     1     2.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT: 8.     1     1.0    0.0    0.0       st1	{ v1.1d, v2.1d, v3.1d, v4.1d }, [x27], x28
# CHECK-NEXT: 9.     1     2.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.5    0.1    0.8       <total>
...
# CHECK:      [0,0]     DeER .    .   st1	{ v1.2d, v2.2d, v3.2d, v4.2d }, [x27], x28
# CHECK-NEXT: [0,1]     D=eER.    .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeeeeER  .   st1	{ v1.2s, v2.2s, v3.2s, v4.2s }, [x27], x28
# CHECK-NEXT: [0,3]     .D=eE--R  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeeeeER .   st1	{ v1.4h, v2.4h, v3.4h, v4.4h }, [x27], x28
# CHECK-NEXT: [0,5]     . D=eE--R .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  DeE--R .   st1	{ v1.4s, v2.4s, v3.4s, v4.4s }, [x27], x28
# CHECK-NEXT: [0,7]     .  D=eE-R .   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .   DeeeeER   st1	{ v1.8b, v2.8b, v3.8b, v4.8b }, [x27], x28
# CHECK-NEXT: [0,9]     .   D=eE--R   add	x0, x27, #1
...
# CHECK-NEXT: 6.     1     1.0    0.0    2.0       st1	{ v1.4s, v2.4s, v3.4s, v4.4s }, [x27], x28
...
# CHECK:      [0,0]     DeER .  .   st1	{ v1.8h, v2.8h, v3.8h, v4.8h }, [x27], x28
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeER.  .   st1	{ v1.16b, v2.16b, v3.16b, v4.16b }, [x27], x28
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeER  .   st1	{ v1.b }[0], [x27], #1
# CHECK-NEXT: [0,5]     . D=eER .   add	x0, x27, #1
...
# CHECK-NEXT: 7.     1     3.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT: 8.     1     2.0    0.0    0.0       st1	{ v1.b }[0], [x27], x28
# CHECK-NEXT: 9.     1     3.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.9    0.1    0.0       <total>
...
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     D=eER.  .   st1	{ v1.h }[0], [x27], #2
# CHECK-NEXT: [0,3]     D==eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eER  .   st1	{ v1.h }[4], [x27], #2
# CHECK-NEXT: [0,5]     .D==eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .D==eER .   st1	{ v1.h }[0], [x27], x28
# CHECK-NEXT: [0,7]     .D===eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     . D==eER.   st1	{ v1.h }[4], [x27], x28
# CHECK-NEXT: [0,9]     . D===eER   add	x0, x27, #1
...
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     D=eER.  .   st1	{ v1.s }[0], [x27], x28
# CHECK-NEXT: [0,3]     D==eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eER  .   st1	{ v1.d }[0], [x27], #8
# CHECK-NEXT: [0,5]     .D==eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .D==eER .   st1	{ v1.d }[0], [x27], x28
# CHECK-NEXT: [0,7]     .D===eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     . D==eER.   st2	{ v1.2d, v2.2d }, [x27], #32
# CHECK-NEXT: [0,9]     . D===eER   add	x0, x27, #1
...
# CHECK:      [0,0]     DeER .  .   st2	{ v1.2s, v2.2s }, [x27], #16
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     D=eER.  .   st2	{ v1.4h, v2.4h }, [x27], #16
# CHECK-NEXT: [0,3]     D==eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eER  .   st2	{ v1.4s, v2.4s }, [x27], #32
# CHECK-NEXT: [0,5]     .D==eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .D==eER .   st2	{ v1.8b, v2.8b }, [x27], #16
# CHECK-NEXT: [0,7]     .D===eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     . D==eER.   st2	{ v1.8h, v2.8h }, [x27], #32
# CHECK-NEXT: [0,9]     . D===eER   add	x0, x27, #1
...
# CHECK:      [0,0]     DeER .  .   st2	{ v1.16b, v2.16b }, [x27], #32
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     D=eER.  .   st2	{ v1.2d, v2.2d }, [x27], x28
# CHECK-NEXT: [0,3]     D==eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eER  .   st2	{ v1.2s, v2.2s }, [x27], x28
# CHECK-NEXT: [0,5]     .D==eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .D==eER .   st2	{ v1.4h, v2.4h }, [x27], x28
# CHECK-NEXT: [0,7]     .D===eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     . D==eER.   st2	{ v1.4s, v2.4s }, [x27], x28
# CHECK-NEXT: [0,9]     . D===eER   add	x0, x27, #1
...
# CHECK:      [0,0]     DeER .  .   st2	{ v1.8b, v2.8b }, [x27], x28
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     D=eER.  .   st2	{ v1.8h, v2.8h }, [x27], x28
# CHECK-NEXT: [0,3]     D==eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eER  .   st2	{ v1.16b, v2.16b }, [x27], x28
# CHECK-NEXT: [0,5]     .D==eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .D==eER .   st2	{ v1.b, v2.b }[0], [x27], #2
# CHECK-NEXT: [0,7]     .D===eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     . D==eER.   st2	{ v1.b, v2.b }[8], [x27], #2
# CHECK-NEXT: [0,9]     . D===eER   add	x0, x27, #1
...
# CHECK:      [0,0]     DeER .  .   st2	{ v1.b, v2.b }[0], [x27], x28
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     D=eER.  .   st2	{ v1.b, v2.b }[8], [x27], x28
# CHECK-NEXT: [0,3]     D==eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eER  .   st2	{ v1.h, v2.h }[0], [x27], #4
# CHECK-NEXT: [0,5]     .D==eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .D==eER .   st2	{ v1.h, v2.h }[4], [x27], #4
# CHECK-NEXT: [0,7]     .D===eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     . D==eER.   st2	{ v1.h, v2.h }[0], [x27], x28
# CHECK-NEXT: [0,9]     . D===eER   add	x0, x27, #1
...
# CHECK:      [0,0]     DeER .  .   st2	{ v1.h, v2.h }[4], [x27], x28
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     D=eER.  .   st2	{ v1.s, v2.s }[0], [x27], #8
# CHECK-NEXT: [0,3]     D==eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eER  .   st2	{ v1.s, v2.s }[0], [x27], x28
# CHECK-NEXT: [0,5]     .D==eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .D==eER .   st2	{ v1.d, v2.d }[0], [x27], #16
# CHECK-NEXT: [0,7]     .D===eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     . D==eER.   st2	{ v1.d, v2.d }[0], [x27], x28
# CHECK-NEXT: [0,9]     . D===eER   add	x0, x27, #1
...
# CHECK:      [0,0]     DeeeeER   .   st3	{ v1.2d, v2.2d, v3.2d }, [x27], #48
# CHECK-NEXT: [0,1]     .DeE--R   .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     . DeeeeER .   st3	{ v1.2s, v2.2s, v3.2s }, [x27], #24
# CHECK-NEXT: [0,3]     .  DeE--R .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .   DeeeeER   st3	{ v1.4h, v2.4h, v3.4h }, [x27], #24
# CHECK-NEXT: [0,5]     .    DeE--R   add	x0, x27, #1
...
# CHECK-NEXT:        6     1.0    0.5    1.0       <total>
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    4.98
# CHECK-NEXT: IPC:               1.00
...
# CHECK-NEXT: [0,7]     .    . DeE--R .   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .    .  DeeeeER   st3	{ v1.2d, v2.2d, v3.2d }, [x27], x28
# CHECK-NEXT: [0,9]     .    .   DeE--R   add	x0, x27, #1
...
# CHECK-NEXT: 9.     1     2.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.1    0.4    1.0       <total>
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    6.93
# CHECK-NEXT: IPC:               1.65
# CHECK-NEXT: Block RThroughput: 5.3
...
# CHECK-NEXT: 5.     1     2.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT: 6.     1     1.0    0.0    0.0       st4	{ v1.8h, v2.8h, v3.8h, v4.8h }, [x27], #64
# CHECK-NEXT: 7.     1     1.0    0.0    2.0       add	x0, x27, #1
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    7.51
# CHECK-NEXT: IPC:               1.98
...
# CHECK-NEXT: [0,3]     .  DeE--R ..   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .  DeeeeER..   st4	{ v1.b, v2.b, v3.b, v4.b }[0], [x27], #4
# CHECK-NEXT: [0,5]     .  D=eE--R..   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .   DeeeeER.   st4	{ v1.b, v2.b, v3.b, v4.b }[8], [x27], #4
# CHECK-NEXT: [0,7]     .   D=eE--R.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .    DeeeeER   st4	{ v1.b, v2.b, v3.b, v4.b }[0], [x27], x28
# CHECK-NEXT: [0,9]     .    D=eE--R   add	x0, x27, #1
...
# CHECK-NEXT: 5.     1     2.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT: 6.     1     1.0    0.0    0.0       st4	{ v1.b, v2.b, v3.b, v4.b }[8], [x27], #4
# CHECK-NEXT: 7.     1     2.0    0.0    2.0       add	x0, x27, #1
...
# CHECK:      [0,0]     DeeeeER   .   st4	{ v1.b, v2.b, v3.b, v4.b }[8], [x27], x28
# CHECK-NEXT: [0,1]     D=eE--R   .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeeeeER  .   st4	{ v1.h, v2.h, v3.h, v4.h }[0], [x27], #8
# CHECK-NEXT: [0,3]     .D=eE--R  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeeeeER .   st4	{ v1.h, v2.h, v3.h, v4.h }[4], [x27], #8
# CHECK-NEXT: [0,5]     . D=eE--R .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  DeeeeER.   st4	{ v1.h, v2.h, v3.h, v4.h }[0], [x27], x28
# CHECK-NEXT: [0,7]     .  D=eE--R.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .   DeeeeER   st4	{ v1.h, v2.h, v3.h, v4.h }[4], [x27], x28
# CHECK-NEXT: [0,9]     .   D=eE--R   add	x0, x27, #1
...
# CHECK-NEXT: [0,1]     D=eE--R  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeeeeER .   st4	{ v1.s, v2.s, v3.s, v4.s }[0], [x27], x28
# CHECK-NEXT: [0,3]     .D=eE--R .   add	x0, x27, #1
...
# CHECK-NEXT: 7.     1     2.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT:        8     1.5    0.1    1.0       <total>
...
# CHECK-NEXT: [0,1]     D=eER.   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeER.   stp	d1, d2, [x27], #496
# CHECK-NEXT: [0,3]     .D=eER   add	x0, x27, #1
...
# CHECK-NEXT: 3.     1     2.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT:        4     1.5    0.3    0.0       <total>
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    6.35
# CHECK-NEXT: IPC:               1.98
# CHECK-NEXT: Block RThroughput: 4.0
...
# CHECK:      [0,0]     DeER .  .   stp	q1, q2, [x27], #992
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeER.  .   stp	s1, s2, [x27, #248]!
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeER  .   stp	d1, d2, [x27, #496]!
# CHECK-NEXT: [0,5]     . D=eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  DeER .   stp	q1, q2, [x27, #992]!
# CHECK-NEXT: [0,7]     .  D=eER.   add	x0, x27, #1
...
# CHECK-NEXT: [0,5]     .D==eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     . D=eER .   str	b1, [x27], #254
# CHECK-NEXT: [0,7]     . D==eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .  D=eER.   str	h1, [x27], #254
# CHECK-NEXT: [0,9]     .  D==eER   add	x0, x27, #1
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    6.94
# CHECK-NEXT: IPC:               1.98
# CHECK-NEXT: Block RThroughput: 4.4
...
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeER  .   str	q1, [x27], #254
# CHECK-NEXT: [0,5]     . D=eER .   add	x0, x27, #1
...
# CHECK-NEXT: 7.     1     2.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT: 8.     1     2.0    0.0    0.0       str	x1, [x27], #254
# CHECK-NEXT: 9.     1     3.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.7    0.1    0.0       <total>
